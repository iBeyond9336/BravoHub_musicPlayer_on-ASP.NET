...
CREATE TABLE `song_playlists` (
  `song_playlist_id` int NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `song_playlists` WRITE;
/*!40000 ALTER TABLE `song_playlists` DISABLE KEYS */;
/*!40000 ALTER TABLE `song_playlists` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-12-15 14:04:08
